...
import { DEFAULT_WORKBOOK_DATA_SIMPLE } from '@univerjs/mockdata';
...
const collaborationUrl =
    'http://3.112.124.111:8099/api/realtime/convergence/default';
// const collaborationUrl =
...
const collaborator = {
    userId: `userId-${radomNum}`,
    userName: `罗科华-${radomNum}`,
    avatar: 'https://images.unsplash.com/photo-1491528323818-fdd1faba62cc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
};
console.log('本地用户： ', collaborator.userName);

// univer.registerPlugin(UniverCollaborationPlugin, {
//     contentId: 'plugin-test-1217', //createUUID(),
//     collaborationUrl,
//     collaborator,
//     data: DEFAULT_WORKBOOK_DATA_DEMO,
// });
univer.registerPlugin(UniverCollaborationPlugin);
/** --------------------------- 协同插件 --------------------------- */
...
collaborationService.start({
    ...
    collaborationUrl,
    collaborator,
    data: DEFAULT_WORKBOOK_DATA_SIMPLE,
});
...
window.univerAPI.onCommandExecuted((command) => {
